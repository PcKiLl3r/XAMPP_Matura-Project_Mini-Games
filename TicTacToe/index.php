...
<body style="display: grid;">
    ...
    <div class="tic-tac-container">
        <div class="tic-tac-row">
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe1" class="tic-tac-col">
            <?php
        if(isset($_SESSION['tictacs'][1])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe2" class="tic-tac-col tic-tac-black">
            <?php
        if(isset($_SESSION['tictacs'][2])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe3" class="tic-tac-col">
            <?php
        ...
        <div class="tic-tac-row">
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe4" class="tic-tac-col tic-tac-black">
            <?php
        if(isset($_SESSION['tictacs'][4])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe5" class="tic-tac-col">
            <?php
        if(isset($_SESSION['tictacs'][5])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe6" class="tic-tac-col tic-tac-black">
            <?php
        ...
        <div class="tic-tac-row">
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe7" class="tic-tac-col">
            <?php
        if(isset($_SESSION['tictacs'][7])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe8" class="tic-tac-col tic-tac-black">
            <?php
        if(isset($_SESSION['tictacs'][8])){
            ...
            <div type="button" data-bs-toggle="modal" data-bs-target="#addTicToe9" class="tic-tac-col">
            <?php
