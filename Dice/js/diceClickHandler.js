...
document.addEventListener("DOMContentLoaded", () => {
      ...
      for (let index = 1; index <= 90; index++) {
        setTimeout(function () {
          ...
          document.querySelector(".dice").style.transform =
            "rotateY(" + index + "deg) rotateX(0deg) rotateZ(0deg)";
        }, globIndex * speed);
        globIndex++;
      }
    } else {
    ...
    if (!isRev) {
      for (let index = 1; index <= 90; index++) {
        setTimeout(function () {
          ...
          document.querySelector(".dice").style.transform =
            "rotateY(90deg) rotateX(0deg) rotateZ(" + index + "deg)";
        }, globIndex * speed);
        globIndex++;
      }
    } else {
    ...
    if (!isRev) {
      for (let index = 91; index <= 180; index++) {
        setTimeout(function () {
          ...
          document.querySelector(".dice").style.transform =
            "rotateY(" + index + "deg) rotateX(0deg) rotateZ(270deg)";
        }, globIndex * speed);
        globIndex++;
      }
    } else {
  ...
  function FrameSkip(globIndex, frameSkip, speed) {
    for (let index = 1; index <= frameSkip; index++) {
      setTimeout(function () {}, globIndex * speed);
      globIndex++;
    }
    return globIndex;
  }
  ...
  function UnderElement(elem, modifier) {
    ...
    return (
      cursor_x > elemPosition.left &&
      cursor_x < elemPosition2.left &&
      cursor_y > elemPosition.top &&
      cursor_y < elemPosition2.top
    );
  }
  ...
  document.querySelectorAll("form").forEach((form) => {
    form.addEventListener("submit", (e) => {
      ...
      // Send dice click info
          ...
          let _clickRes = await SendMove();
          if (_clickRes == "InProgress") {

          } else if (_clickRes == "Inactive") {
